<?php
/* Smarty version 3.1.29, created on 2018-06-21 11:17:11
  from "/Users/michaelchang/Documents/michael/php/ele/templates/j00_prod_form.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5b2b6d17761229_35824460',
  'file_dependency' => 
  array (
    '7d57c64ed4320efb5c08e2cdc623e0feb403ea20' => 
    array (
      0 => '/Users/michaelchang/Documents/michael/php/ele/templates/j00_prod_form.tpl',
      1 => 1529572626,
      2 => 'file',
    ),
  ),
  ...
  array (
    'file:header.tpl' => 1,
    'file:j00_prod_fix.tpl' => 1,
    'file:k10_inq_prod.tpl' => 1,
    'file:footer.tpl' => 1,
  ),
),false)) {
function content_5b2b6d17761229_35824460 ($_smarty_tpl) {
...
<?php echo '<script'; ?>
 type="text/javascript" src="class/datatable/datatable.min.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 type="text/javascript" src="class/datatable/datatable.jquery.min.js"><?php echo '</script'; ?>
>
    ...
    <form action="j00_prod.php" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
      <div class="row">
        <div class="form-group">
          ...
          <div class="col-md-2">
            <input type="text" class="form-control" id="prod_no"  name="prod_no"  value="<?php echo $_smarty_tpl->tpl_vars['VAL']->value['prod_no'];?>
">
          </div>

          <label class="col-md-1" style="text-align: right; padding-right: 0;">產品名稱</label>
          <div class="col-md-5">
            <input type="text" class="form-control" id="description " name="description" value="<?php echo $_smarty_tpl->tpl_vars['VAL']->value['description'];?>
" >
          </div>

          <label class="col-md-1" style="text-align: right; padding-right: 0;">單位</label>
          <div class="col-md-2">
            <input type="text" class="form-control" id="c_unit"  name="c_unit"  value="<?php echo $_smarty_tpl->tpl_vars['VAL']->value['c_unit'];?>
" >
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="form-group">
          ...
          <div class="col-md-2">
            <input type="text" class="form-control" id="barcode"  name="barcode"  value="<?php echo $_smarty_tpl->tpl_vars['VAL']->value['barcode'];?>
" >
          </div>
          <label class="col-md-1" style="text-align: right; padding-right: 0;">國際碼</label>
          <div class="col-md-2">
            <input type="text" class="form-control" id="inter_code"  name="inter_code"  value="<?php echo $_smarty_tpl->tpl_vars['VAL']->value['inter_code'];?>
" >
          </div>

          <label class="col-md-1" style="text-align: right; padding-right: 0;">存放儲位</label>
          <div class="col-md-2">
            <input type="text" class="form-control" id="c_locatn"  name="c_locatn"  value="<?php echo $_smarty_tpl->tpl_vars['VAL']->value['c_locatn'];?>
" >
          </div>

          <label class="col-md-1" style="text-align: right; padding-right: 0;">安全庫存量</label>
          <div class="col-md-2">
            <input type="text" class="form-control" id="c_safe"  name="c_safe"  value="<?php echo $_smarty_tpl->tpl_vars['VAL']->value['c_safe'];?>
" >
          </div>
      ...
      <div class="row">
        <div class="form-group">
          ...
          <div class="col-md-2">
            <input type="text" class="form-control" id="c_prod"  name="c_prod"  value="<?php echo $_smarty_tpl->tpl_vars['VAL']->value['c_prod'];?>
" >
          </div>
          ...
          <div class="col-md-2">
            <select name="c_brand" class="form-control" size="1" style="height: 34px;">
              <?php echo $_smarty_tpl->tpl_vars['VAL']->value['sele_brand'];?>
          ...
          <div class="col-md-2">
            <select name="c_type" class="form-control" size="1" style="height: 34px;">
              <?php echo $_smarty_tpl->tpl_vars['VAL']->value['sele_type'];?>
      ...
      <div class="row">
        <div class="form-group">
          ...
          <div class="col-md-2">
            <input type="text" class="form-control" id="in_price"  name="in_price"  value="<?php echo $_smarty_tpl->tpl_vars['VAL']->value['in_price'];?>
" >
          </div>

          <label class="col-md-1" style="text-align: right; padding-right: 0;">一般銷貨價</label>
          <div class="col-md-2">
            <input type="text" class="form-control" id="sale_price"  name="sale_price"  value="<?php echo $_smarty_tpl->tpl_vars['VAL']->value['sale_price'];?>
" >
          </div>

          <label class="col-md-1" style="text-align: right; padding-right: 0;">同行批發價</label>
          <div class="col-md-2">
            <input type="text" class="form-control" id="c_price1"  name="c_price1"  value="<?php echo $_smarty_tpl->tpl_vars['VAL']->value['c_price1'];?>
" >
          </div>

          <label class="col-md-1" style="text-align: right; padding-right: 0;">賣廠批發價</label>
          <div class="col-md-2">
            <input type="text" class="form-control" id="c_price3"  name="c_price3"  value="<?php echo $_smarty_tpl->tpl_vars['VAL']->value['c_price3'];?>
" >
          </div>
      ...
      <div class="row">
        <div class="form-group">
          ...
          <div class="col-md-2">
            <input type="text" class="form-control" id="c_price2"  name="c_price2"  value="<?php echo $_smarty_tpl->tpl_vars['VAL']->value['c_price2'];?>
" >
          </div>

          <label class="col-md-1" style="text-align: right; padding-right: 0;">平均單價</label>
          <div class="col-md-2">
            <input type="text" class="form-control" id="c_price_av"  name="c_price_av"  value="<?php echo $_smarty_tpl->tpl_vars['VAL']->value['c_price_av'];?>
" >
          </div>

          <label class="col-md-1" style="text-align: right; padding-right: 0;">回收處理廢</label>
          <div class="col-md-2">
            <input type="text" class="form-control" id="c_return"  name="c_return"  value="<?php echo $_smarty_tpl->tpl_vars['VAL']->value['c_return'];?>
" >
          </div>
          ...
          <div class="col-md-2">
            <input type="text" class="form-control" id="c_date"  name="c_date"  value="<?php echo $_smarty_tpl->tpl_vars['VAL']->value['c_date'];?>
" >
          </div>
      ...
      <div class="row">
        <?php echo '<script'; ?>
 src="<?php echo $_smarty_tpl->tpl_vars['xoops_url']->value;?>
/modules/tadtools/cal.php" type="text/javascript"><?php echo '</script'; ?>
>

        <div class="form-group">
          <label class="col-md-1" style="text-align: right; padding-right: 0;">管理庫存</label>
          <div class="col-md-2">
            <input type='radio' name='c_yn' id='c_yn_1' value='1' <?php if ($_smarty_tpl->tpl_vars['VAL']->value['c_yn'] == 1) {?>checked<?php }?>>
              <label for='c_yn_1'>是</label>&nbsp;&nbsp;
            <input type='radio' name='c_yn' id='c_yn_2' value='2' <?php if ($_smarty_tpl->tpl_vars['VAL']->value['c_yn'] == 2) {?>checked<?php }?>>
              <label for='c_yn_2'>否</label>
          </div>

          <label class="col-md-1" style="text-align: right; padding-right: 0;">備註</label>
          <div class="col-md-8">
            <input type="text" class="form-control" id="c_remark " name="c_remark" value="<?php echo $_smarty_tpl->tpl_vars['VAL']->value['c_remark'];?>
" >
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="form-group">
          ...
          <div class="col-md-8">
            <textarea class="form-control" rows="3" id="title" name="title"><?php echo $_smarty_tpl->tpl_vars['VAL']->value['title'];?>
</textarea>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="form-group">
          ...
          <div class="col-md-8">
            <textarea class="form-control" rows="3" id="content" name="content"><?php echo $_smarty_tpl->tpl_vars['VAL']->value['content'];?>
</textarea>
          </div>
        </div>
      </div>
      ...
      <div class="form-group">
          <input type="hidden" name="prod_id" value="<?php echo $_smarty_tpl->tpl_vars['VAL']->value['prod_id'];?>
" />
          <input type="hidden" name="op" value="<?php echo $_smarty_tpl->tpl_vars['op1']->value;?>
" />
      ...
      <div class="row">
          <?php echo $_smarty_tpl->tpl_vars['VAL']->value['img'];?>
  ...
  <div class="tab-content-2" style="padding-top: 10px">
    ...
    <table class="table table-bordered table-hover table-striped" id="myTable">
      ...
      <tbody>
        <?php
$_from = $_smarty_tpl->tpl_vars['alls']->value;
...
?>
          <tr>
            <td> <?php echo $_smarty_tpl->tpl_vars['prods']->value['c_seq'];?>
 </td>
            <td> <?php echo $_smarty_tpl->tpl_vars['prods']->value['prod_no_fix'];?>
 </td>
            <td> <?php echo $_smarty_tpl->tpl_vars['prods']->value['description'];?>
 </td>
            <td> <?php echo $_smarty_tpl->tpl_vars['prods']->value['c_qty'];?>
 </td>
            <td> <?php echo $_smarty_tpl->tpl_vars['prods']->value['c_unit'];?>
 </td>
            <td> <?php echo $_smarty_tpl->tpl_vars['prods']->value['c_wage'];?>
 </td>
            <td> <?php echo $_smarty_tpl->tpl_vars['prods']->value['c_cost'];?>
 </td>
            <td> <?php echo $_smarty_tpl->tpl_vars['prods']->value['c_sale'];?>
 </td>
            <td> <?php echo $_smarty_tpl->tpl_vars['prods']->value['c_remark'];?>
 </td>
            <td>
              <a href="javascript:void(0)" class="edit1   btn btn-warning btn-xs" sn="<?php echo $_smarty_tpl->tpl_vars['prods']->value['prod_fix_id'];?>
" >編輯</a>
              <a href="javascript:void(0)" class="delete1 btn btn-danger btn-xs" sn="<?php echo $_smarty_tpl->tpl_vars['prods']->value['prod_fix_id'];?>
" sn-msg="<?php echo $_smarty_tpl->tpl_vars['prods']->value['prod_no_fix'];?>
">刪除</a>              
            </td>            
          </tr>
        <?php
...
<?php $_smarty_tpl->smarty->ext->_subtemplate->render($_smarty_tpl, "file:j00_prod_fix.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, false);
?>

<?php $_smarty_tpl->smarty->ext->_subtemplate->render($_smarty_tpl, "file:k10_inq_prod.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, false);
?>
...
>
  ...
  $(document).ready(function() {
    ...
    $('#save1').on("click",function(e){
      ...
      str1 += "sn='<?php echo $_smarty_tpl->tpl_vars['prods']->value['prod_fix_id'];?>
' >編輯</a>";
